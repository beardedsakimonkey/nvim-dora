...
M.config = {
    keymaps = {
        ...
        R = {"<Cmd>lua require'dirtree.core'.reload()<CR>",                 desc="Reload listing"},
        ...
        d = {"<Cmd>lua require'dirtree.core'.delete()<CR>",                 desc="Delete file"},
        a = {"<Cmd>lua require'dirtree.core'.create()<CR>",                 desc="Create file"},
        r = {"<Cmd>lua require'dirtree.core'.rename()<CR>",                 desc="Rename file"},
        m = {"<Cmd>lua require'dirtree.core'.move()<CR>",                   desc="Move file"},
        ...
        gh = {"<Cmd>lua require'dirtree.core'.home_dir()<CR>",              desc="Go to Home directory"},
