...
M.config = {
    keymaps = {
        ...
        o = {"expand", desc="Expand"},
        O = {"expand_recursive", desc="Expand recursively"},
        u = {"collapse", desc="Collapse descendants"},
        U = {"collapse_reset", desc="Collapse and reset"},
        l = {"open", desc="Open"},
        ['<CR>'] = {"open", desc="Open"},
        ...
        gY = {"yank_path_clipboard", desc="Yank path to clipboard"},
        ...
        cn = {"copy_filename_stem", desc="Copy filename without extension"},
        cN = {"copy_filename_stem_clipboard", desc="Copy filename without extension to clipboard"},
