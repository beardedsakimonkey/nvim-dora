...
require'dora'.setup {
    ...
    keymaps = {
        ...
        ['<BS>'] = {"parent_dir",               desc="Go to and collapse parent directory"},
        ...
        ['<C-s>'] = {"open_split_keep",         desc="In-place open in split"},
        ['<C-v>'] = {"open_vsplit_keep",        desc="In-place open in vertical split"},
        ['<C-t>'] = {"open_tab_keep",           desc="In-place open in tab"},
        ...
        R = {"rename_empty",                    desc="Rename file with empty prompt"},
        ...
        p = {"paste",                           desc="Paste under directory"},
        P = {"paste_parent",                    desc="Paste under parent directory"},
