...
Set `dora.config.insert_only_prompts = true` to keep add, rename, symlink, and
shell prompts in insert mode. With this enabled, pressing `<Esc>` once cancels
the prompt instead of entering normal mode.
