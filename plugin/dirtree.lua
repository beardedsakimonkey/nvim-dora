...
vim.cmd 'hi default link DirtreePromptCompletion    NonText'
vim.cmd 'hi default link DirtreeDeleteMore          NonText'
vim.cmd 'hi default link DirtreeDeleteCursor        Normal'
vim.cmd 'hi default link DirtreeMarkedText          Special'
vim.cmd 'hi default link DirtreeMarkedSign          Special'
vim.cmd 'hi default link DirtreeCutSign             DiagnosticWarn'
vim.cmd 'hi default link DirtreeCopySign            DiagnosticInfo'
